...
export default function SchedulePage() {
  ...
  return (
    <section className="mx-auto max-w-[88rem] space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Scheduled posts</h2>
          <p className="text-sm text-slate-500">Only your queued and scheduled content appears here.</p>
        </div>
      ...
      <article className="overflow-hidden rounded-2xl border-2 border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900">
