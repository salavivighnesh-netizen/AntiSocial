...
export const WORKSPACE_SHELL = "mx-auto flex w-full max-w-[88rem] flex-col px-1 sm:px-2";
export const WORKSPACE_CARD =
  "flex max-h-[min(820px,calc(100vh-7rem))] min-h-[min(640px,calc(100vh-10rem))] flex-1 flex-col overflow-hidden rounded-2xl border-2 border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900";
